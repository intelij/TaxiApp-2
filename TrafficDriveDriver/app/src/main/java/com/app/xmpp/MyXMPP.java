...
public class MyXMPP {
    ...
    public int sendUserTwo(String senderID, String mMessage) {
        ...
        if (!chattwo_created) {
            MyChat_user_two = ChatManager.getInstanceFor(connection).createChat(senderID, mMessageListener);
    ...
    public int sendMessageServer(String senderID, String mMessage) {
        ...
        if (!server_chat_created) {
            MyServerchat = ChatManager.getInstanceFor(connection).createChat(senderID, mMessageListener);
